...
var files = fs.readdirSync("/home/oee/Pulse/BYD_L56_LOGS/"); //Leer documentos
  ...
  if(secPubNub>=60*5){
    ...
    function idle(){
      ...
      for ( k=0;k<files.length;k++){//Verificar los archivos
        var stats = fs.statSync("/home/oee/Pulse/BYD_L56_LOGS/"+files[k]);
        ...
        var statesBottleSorter        = switchData(resp.register[0],resp.register[1]),
          ...
          if(isNaN(Barcode)){
	        ...
	        if(secBarcode>=60&&!isNaN(Barcode)){
              writedataBarcode(Barcode,"pol_byd_Barcode_L56.log");
              secBarcode=0;
          }
          secBarcode++;
          //Barcode -------------------------------------------------------------------------------------------------------------
          //BottleSorter -------------------------------------------------------------------------------------------------------------
            ...
            if(flagPrintBottleSorter==1){
                for(var key in BottleSorter){
                    fs.appendFileSync("/home/oee/Pulse/BYD_L56_LOGS/pol_byd_BottleSorter_L56.log","tt="+timeBottleSorter+",var="+key+",val="+BottleSorter[key]+"\n");
                }
          ...
          //BottleOrientator -------------------------------------------------------------------------------------------------------------
            ...
            if(flagPrintBottleOrientator==1){
                for(var key in BottleOrientator){
                   fs.appendFileSync("/home/oee/Pulse/BYD_L56_LOGS/pol_byd_BottleOrientator_L56.log","tt="+timeBottleOrientator+",var="+key+",val="+BottleOrientator[key]+"\n");
              }
          ...
          //Fillercapper -------------------------------------------------------------------------------------------------------------
            ...
            if(flagPrintFillercapper==1){
                for(var key in Fillercapper){
                    fs.appendFileSync("/home/oee/Pulse/BYD_L56_LOGS/pol_byd_Fillercapper_L56.log","tt="+timeFillercapper+",var="+key+",val="+Fillercapper[key]+"\n");
                }
          ...
          //CapSorter -------------------------------------------------------------------------------------------------------------
            ...
            if(flagPrintCapSorter==1){
                for(var key in CapSorter){
                    fs.appendFileSync("/home/oee/Pulse/BYD_L56_LOGS/pol_byd_CapSorter_L56.log","tt="+timeCapSorter+",var="+key+",val="+CapSorter[key]+"\n");
                }
          ...
          //Depuck -------------------------------------------------------------------------------------------------------------
            ...
            if(flagPrintDepuck==1){
                for(var key in Depuck){
                    fs.appendFileSync("/home/oee/Pulse/BYD_L56_LOGS/pol_byd_Depuck_L56.log","tt="+timeDepuck+",var="+key+",val="+Depuck[key]+"\n");
                }
                flagPrintDepuck=0;
            }
          //Depuck -------------------------------------------------------------------------------------------------------------
          //Labeller -------------------------------------------------------------------------------------------------------------
            ctLabeller = joinWord(resp.register[39],resp.register[38]);
              if(flagONS6===0){
            ...
            if(flagPrintLabeller==1){
                for(var key in Labeller){
                    fs.appendFileSync("/home/oee/Pulse/BYD_L56_LOGS/pol_byd_Labeller_L56.log","tt="+timeLabeller+",var="+key+",val="+Labeller[key]+"\n");
                }
                flagPrintLabeller=0;
            }
          //Labeller -------------------------------------------------------------------------------------------------------------
          //Shrinkwrapper -------------------------------------------------------------------------------------------------------------
            ctShrinkwrapper = joinWord(resp.register[45],resp.register[44]);
              if(flagONS7===0){
            ...
            if(flagPrintShrinkwrapper==1){
                for(var key in Shrinkwrapper){
                    fs.appendFileSync("/home/oee/Pulse/BYD_L56_LOGS/pol_byd_Shrinkwrapper_L56.log","tt="+timeShrinkwrapper+",var="+key+",val="+Shrinkwrapper[key]+"\n");
                }
          ...
          //Casepacker -------------------------------------------------------------------------------------------------------------
            ...
            if(flagPrintCasepacker==1){
                for(var key in Casepacker){
                    fs.appendFileSync("/home/oee/Pulse/BYD_L56_LOGS/pol_byd_Casepacker_L56.log","tt="+timeCasepacker+",var="+key+",val="+Casepacker[key]+"\n");
                }
          ...
          //Printer -------------------------------------------------------------------------------------------------------------
            ...
            if(flagPrintPrinter==1){
                for(var key in Printer){
                    fs.appendFileSync("/home/oee/Pulse/BYD_L56_LOGS/pol_byd_Printer_L56.log","tt="+timePrinter+",var="+key+",val="+Printer[key]+"\n");
                }
                flagPrintPrinter=0;
            }
          //Printer -------------------------------------------------------------------------------------------------------------
          //Checkweigher -------------------------------------------------------------------------------------------------------------
            ctCheckweigher = joinWord(resp.register[59],resp.register[58]);
              if(flagONS10===0){
            ...
            if(flagPrintCheckweigher==1){
                for(var key in Checkweigher){
                    fs.appendFileSync("/home/oee/Pulse/BYD_L56_LOGS/pol_byd_Checkweigher_L56.log","tt="+timeCheckweigher+",var="+key+",val="+Checkweigher[key]+"\n");
                }
          ...
          //Paletizer -------------------------------------------------------------------------------------------------------------
            ...
            if(flagPrintPaletizer==1){
                for(var key in Paletizer){
                    fs.appendFileSync("/home/oee/Pulse/BYD_L56_LOGS/pol_byd_Paletizer_L56.log","tt="+timePaletizer+",var="+key+",val="+Paletizer[key]+"\n");
                }
          ...
          //EOL --------------------------------------------------------------------------------------------------------------------
          if(secEOL>=60){
            fs.appendFileSync("../BYD_L56_LOGS/pol_byd_EOL_L56.log","tt="+Date.now()+",var=EOL"+",val="+Paletizer.CPQI+"\n");
            secEOL=0;
          }
          secEOL++;
          //EOL --------------------------------------------------------------------------------------------------------------------
...
var writedata = function (varJson,nameFile){
    ...
    for(var key in varJson){
        fs.appendFileSync("/home/pi/Pulse/BYD_L56_LOGS/"+nameFile,"tt="+timet+",var="+key+",val="+varJson[key]+"\n");
    }
};

var writedataBarcode = function (barcode,nameFile){
    var timet=Date.now();
    fs.appendFileSync("../BYD_L56_LOGS/"+nameFile,"tt="+timet+",var=bc"+",val="+barcode+"\n");
};
